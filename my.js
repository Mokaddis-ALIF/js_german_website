...
const selectedItemShow = () => {
    ...
    newDiv.innerHTML = `<div style="display: 100%;display: flex;justify-content: start; max-width: 1024px; margin: 0 auto; padding-top: 60px; font-size: 28px; font-weight: 600;">What are you interested in?
    </div>
    <div style="width: 100%; display: flex; gap: 12px; max-width: 1024px; margin: 0 auto; padding-top: 10px;">
      
        <div style="width: 100%; height: 160px; background: var(--blau, #1E9FC4); display: flex; flex-direction: column;" onclick="toggleSelection('1')">
            <div style="display: flex; justify-content: flex-end; padding-right: 10px; padding-top: 5px; cursor: pointer;">
            ...
            <div style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
                <svg xmlns="http://www.w3.org/2000/svg" width="47" height="51" viewBox="0 0 47 51" fill="none">
                  ...
                  <span style="padding-top: 12px; padding-bottom: 5px; font-weight: 700;">  Tagesgeldkonto </span>
                    <span style="padding-bottom: 14px; font-size: 16px; font-weight: 300;">  Geld parken und 0,6 % Zinsen p. a. sichern</span>
    
    
            </div>
        </div>
        <div style="width: 100%; height: 160px; background: var(--blau, #1E9FC4); display: flex; flex-direction: column;" onclick="toggleSelection('2')">
            <div style="display: flex; justify-content: flex-end; padding-right: 10px; padding-top: 5px; cursor: pointer;">
            ...
            <path d="M21.8 24.4667L28.7334 16.4667L33 19.6667L39.8878 12.2491M39.8878 12.2491L39.9334 12.2L38.8667 11.1333L43.1334 9L41.5334 13.2667L39.8878 12.2491Z" stroke="white" stroke-linecap="round"/>
                  ...
                  <span style="padding-top: 12px; padding-bottom: 5px; font-weight: 700;">  Wertpapiere </span>
                    <span style="padding-bottom: 14px; font-size: 16px; font-weight: 300;"> Vermögensaufbau und Sparen</span>
            </div>
        </div>
        <div style="width: 100%; height: 160px; background: var(--blau, #1E9FC4); display: flex; flex-direction: column;" onclick="toggleSelection('3')">
            <div style="display: flex; justify-content: flex-end; padding-right: 10px; padding-top: 5px; cursor: pointer;">
            ...
            <path d="M42.7392 28.6922V34.8511V35.9123M42.7392 28.6922V23.7023C42.7392 22.0454 41.396 20.7023 39.7392 20.7023H4C2.34315 20.7023 1 22.0454 1 23.7023V28.6922M42.7392 28.6922H21.8696H1M1 28.6922V35.9123M42.7392 35.9123V46C42.7392 47.6569 41.396 49 39.7392 49H4C2.34315 49 1 47.6569 1 46V35.9123M42.7392 35.9123H1" stroke="white" stroke-width="2"/>
                  ...
                  <span style="padding-top: 12px; padding-bottom: 5px; font-weight: 700;">  Girokonto </span>
                    <span style="padding-bottom: 14px; font-size: 16px; font-weight: 300;">  
                    Unsere Klassiker mit Top-Konditionen</span>
            </div>
       ...
       <div style="width: 100%; max-width: 1024px; margin:40px auto; border-bottom: 1px solid grey; padding-bottom: 10px;">We found <span id='results'>6</span> products that match your interests.</div>
      
        <div id="product_one" style="max-width: 1024px; margin: 40px auto;">
       <div style="display: flex; align-items:center;">
           <svg xmlns="http://www.w3.org/2000/svg" width="42" height="44" viewBox="0 0 42 44" fill="none">
             ...
             <div style="padding-left: 10px;">
               <span style="font-size: 16px; font-weight: 700;">Tagesgeldkonto</span> <br>
               <span style="font-size: 14px; font-weight: 300;">1 Produkt</span>
             </div>
       </div>
       <div class="block_benefits container">
           ...
           <div class="col-12 col-sm-6 col-md-6 image__part">
               <figure>
                   <picture>
                       <img class="image__anchor" src="https://aktionen.consorsbank.de/ev/ev_beste_angebote/assets/images/Tagesgeld_Beste_Angebote_482x247.jpg" alt="Daily money image" srcset="" height="247" width="482">
                   </picture>
               </figure>
           </div>
    ...
    <div id="product_two" style="max-width: 1024px; margin: 40px auto;">
       <div style="display: flex; align-items:center;">
           <svg xmlns="http://www.w3.org/2000/svg" width="52" height="42" viewBox="0 0 52 42" fill="none">
             ...
             <div style="padding-left: 10px;">
                <span style="font-size: 16px; font-weight: 700;">Wertpapiere</span> <br>
               <span style="font-size: 14px; font-weight: 300;"> 3 Produkte</span>
       ...
       <div class="block_benefits container">
           ...
           <div class="col-12 col-sm-6 col-md-6 image__part">
               <figure>
                   <picture>
                       <img class="image__anchor" src="https://aktionen.consorsbank.de/ev/ev_beste_angebote/assets/images/Wertpapierdepot_Beste_Angebote_482x247.jpg" alt="Daily money image" srcset="" height="247" width="482">
                   </picture>
               </figure>
           </div>
           <div class="content col-12 col-sm-6 col-md-6">
    ...
    <div id="product_three" style="max-width: 1024px; margin: 40px auto;">
       <div style="display: flex; align-items:center;">
            ...
            <path d="M33.5752 22.8815V27.6882V28.5164M33.5752 22.8815V19.6458C33.5752 17.989 32.232 16.6458 30.5752 16.6458H4C2.34315 16.6458 1 17.989 1 19.6458V22.8815M33.5752 22.8815H17.2876H1M1 22.8815V28.5164M33.5752 28.5164V35.7307C33.5752 37.3875 32.232 38.7307 30.5752 38.7307H4C2.34314 38.7307 1 37.3875 1 35.7307V28.5164M33.5752 28.5164H1" stroke="#464646" stroke-width="2"/>
             ...
             <div style="padding-left: 10px;">
               ...
               <span style="font-size: 16px; font-weight: 700;"> Girokonto</span> <br>
               <span style="font-size: 14px; font-weight: 300;">2 Produkte</span>
             </div>
       </div>
       <div class="block_benefits container">
           <div class="benefit row">
           <div class="col-12 col-sm-6 col-md-6 image__part">
               <figure>
                   <picture>
                       <img class="image__anchor" src="https://aktionen.consorsbank.de/ev/ev_beste_angebote/assets/images/Girokonto_Vergleichsseite_Beste-Angebote-1_482x247.jpg" alt="Daily money image" srcset="" height="247" width="482">
                   </picture>
               </figure>
           </div>
           <div class="content col-12 col-sm-6 col-md-6">
